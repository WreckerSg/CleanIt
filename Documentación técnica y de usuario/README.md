...
|---|---|---|
| 2.1 | Base Django, autenticación, roles, panel inicial y administración de cuentas | Implementado en `dev`; pendiente de promoción a `qa` |
| 2.2 | Gestión de personas, zonas y tareas | Pendiente |
